...
Service for interacting with YouTube API for music streaming.
"""
...
class YouTubeService:
    ...
    def __init__(self, api_key: str = None):
        ...
        Args:
            api_key: YouTube API key (optional, yt_dlp works without it)
        """
    ...
    def is_available(self) -> bool:
        ...
        # yt_dlp works without API key, so always available
        return True
