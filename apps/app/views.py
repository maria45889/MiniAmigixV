...
def entretenimiento(request):
    recomendaciones = {
        'peliculas': [
            ...
            {'titulo': 'Avatar: The Way of Water', 'descripcion': 'Jake Sully vive con su nueva familia en Pandora, pero una antigua amenaza regresa para terminar lo que fue comenzado antes.', 'genero': 'Ciencia Ficción', 'director': 'James Cameron', 'anio': '2022', 'duracion': '3h 12min', 'calificacion': '7.6', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=Avatar+Way+of+Water', 'url': '#'},
            {'titulo': 'Inception', 'descripcion': 'Un ladrón que roba secretos corporativos a través del uso de tecnología de compartir sueños es encargado con la tarea inversa de plantar una idea en la mente de un CEO.', 'genero': 'Acción', 'director': 'Christopher Nolan', 'anio': '2010', 'duracion': '2h 28min', 'calificacion': '8.8', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=Inception', 'url': '#'},
            {'titulo': 'Dune: Parte Dos', 'descripcion': 'Paul Atreides se une a Chani y a los Fremen mientras busca venganza contra los conspiradores que destruyeron a su familia.', 'genero': 'Ciencia Ficción', 'director': 'Denis Villeneuve', 'anio': '2024', 'duracion': '2h 46min', 'calificacion': '8.5', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=Dune+Part+Two', 'url': '#'},
            {'titulo': 'The Matrix', 'descripcion': 'Un programador de computadoras descubre que la realidad como la conoce es una simulación generada por una inteligencia artificial.', 'genero': 'Acción', 'director': 'Lilly y Lana Wachowski', 'anio': '1999', 'duracion': '2h 16min', 'calificacion': '8.7', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=The+Matrix', 'url': '#'},
            {'titulo': 'Spider-Man: No Way Home', 'descripcion': 'Peter Parker pide ayuda a Doctor Strange para restaurar su secreto de identidad, desatando villanos de múltiples universos.', 'genero': 'Acción', 'director': 'Jon Watts', 'anio': '2021', 'duracion': '2h 28min', 'calificacion': '8.2', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=Spider-Man', 'url': '#'},
            {'titulo': 'Oppenheimer', 'descripcion': 'La historia del científico estadounidense J. Robert Oppenheimer y su papel en el desarrollo de la bomba atómica durante la Segunda Guerra Mundial.', 'genero': 'Drama', 'director': 'Christopher Nolan', 'anio': '2023', 'duracion': '3h 0min', 'calificacion': '8.9', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=Oppenheimer', 'url': '#'}
        ],
        'series': [
            {'titulo': 'Breaking Bad', 'descripcion': 'Un profesor de química diagnosticado con cáncer terminal se asocia con un ex alumno para fabricar y vender metanfetamina con el fin de asegurar el futuro de su familia.', 'genero': 'Drama', 'director': 'Vince Gilligan', 'anio': '2008–2013', 'duracion': '5 temporadas', 'calificacion': '9.5', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=Breaking+Bad', 'url': '#'},
            {'titulo': 'Stranger Things', 'descripcion': 'Cuando un niño desaparece, sus amigos, la familia y la policía local se ven envueltos en un misterio extraordinario que involucra experimentos secretos del gobierno.', 'genero': 'Ciencia Ficción', 'director': 'Los Hermanos Duffer', 'anio': '2016–2025', 'duracion': '5 temporadas', 'calificacion': '8.7', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=Stranger+Things', 'url': '#'},
            {'titulo': 'The Last of Us', 'descripcion': 'Veinte años después de la destrucción de la civilización moderna, Joel es contratado para sacar de contrabando a Ellie, una chica de 14 años, fuera de una opresiva zona de cuarentena.', 'genero': 'Drama', 'director': 'Craig Mazin', 'anio': '2023–Presente', 'duracion': '2 temporadas', 'calificacion': '8.8', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=The+Last+of+Us', 'url': '#'},
            {'titulo': 'House of the Dragon', 'descripcion': 'La historia de la Casa Targaryen, ambientada 200 años antes de los eventos de Game of Thrones durante la guerra civil sucesoria conocida como la Danza de los Dragones.', 'genero': 'Fantasía', 'director': 'Ryan Condal', 'anio': '2022–Presente', 'duracion': '2 temporadas', 'calificacion': '8.4', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=House+of+Dragon', 'url': '#'},
            {'titulo': 'The Boys', 'descripcion': 'Un grupo de vigilantes se propone acabar con superhéroes que abusan de sus superpoderes al servicio de una poderosa corporación.', 'genero': 'Acción', 'director': 'Eric Kripke', 'anio': '2019–2024', 'duracion': '4 temporadas', 'calificacion': '8.7', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=The+Boys', 'url': '#'},
            {'titulo': 'Game of Thrones', 'descripcion': 'Nueve familias nobles luchan por el control de la tierra mítica de Westeros, mientras un antiguo enemigo regresa desde el norte.', 'genero': 'Fantasía', 'director': 'David Benioff y D. B. Weiss', 'anio': '2011–2019', 'duracion': '8 temporadas', 'calificacion': '9.2', 'imagen': 'https://placehold.co/600x900/1a1a2e/ffffff?text=Game+of+Thrones', 'url': '#'}
        ],
        'anime': [
